...
class FernandUserAdmin(admin.ModelAdmin):
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        return super(FernandUserAdmin, self).get_fieldsets(request, obj)
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        return super(FernandUserAdmin, self).get_form(request, obj, **defaults)
    ...
    def add_view(self, request, form_url='', extra_context=None):
        ...
        return super(FernandUserAdmin, self).add_view(request, form_url,
                                                    extra_context)
    ...
    def response_add(self, request, obj, post_url_continue=None):
        ...
        return super(FernandUserAdmin, self).response_add(request, obj,
                                                        post_url_continue)


class FernandUserCreationForm(forms.ModelForm):
