...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FernandUser.subscribed_to_mailing'
        db.add_column(u'people_fernanduser', 'subscribed_to_mailing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FernandUser.subscribed_to_mailing'
        db.delete_column(u'people_fernanduser', 'subscribed_to_mailing')
